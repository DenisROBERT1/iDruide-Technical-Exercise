========================================================================
    APPLICATION WIN32 : Vue d'ensemble du projet SvcInterface
========================================================================

AppWizard a créé cette application SvcInterface pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application SvcInterface.


SvcInterface.vcxproj
...
small.ico
    ...
    ressources principal SvcInterface.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé SvcInterface.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
